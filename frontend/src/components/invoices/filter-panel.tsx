...
import { StatusFilter, DateRangeFilter, AmountRangeFilter, SupplierFilter, CategoryFilter,
         CurrencyFilter, SourceTypeFilter, LlmProviderFilter, ConfidenceFilter } from './filters';
            ...
            <CollapsibleContent className="mt-4">
                <Card>
                    <CardHeader className="pb-3 border-b mb-3 bg-muted/20">
                        <CardTitle className="text-base font-medium">Detaylı Filtreleme Seçenekleri</CardTitle>
                    </CardHeader>
