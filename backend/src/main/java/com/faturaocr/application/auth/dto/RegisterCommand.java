...
public record RegisterCommand(
        ...
        @Schema(description = "Company ID to join (leave null to create a new company)", example = "123e4567-e89b-12d3-a456-426614174000") java.util.UUID companyId,

        @Schema(description = "Company name (required if creating new company)", example = "Ornek AS") String companyName,

        @Schema(description = "Company tax number (10 digits, required if creating new company)", example = "1234567890") String taxNumber,
